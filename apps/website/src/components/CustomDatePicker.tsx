...
export default function CustomDatePicker({ value, onChange, placeholder = 'dd/mm/yyyy', className = '', disabled = false, isInvalid = false, onFocus }: CustomDatePickerProps) {
    ...
    <div ref={containerRef} className="relative w-full">
      ...
      <div className="relative flex items-center">
        <input
          ...
          className={`w-full bg-[#020817] border rounded-xl py-3 pl-4 pr-11 text-sm text-white placeholder-gray-500 outline-none transition-all duration-200 ${
            isInvalid
